...
class Node:
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # TODO change name to connect_to_publishers_topics
    ...
    # def connect_to_higher_id_servers(self):
    #     for node in self.nodes:
    #         if node.network_id > self.network_id:
    #             self
    ...
    def establish_connection(self, TIMEOUT: int) -> None:
        ...
        for node in self.nodes:
            if node.network_id > self.network_id:
                ...
                client_socket.setsockopt(zmq.RCVTIMEO, TIMEOUT)  # set the timeout duration to TIMEOUT
        ...
        # TODO should this be before the above for loop?
        ...
        for client in self.clients:
            ...
            try:
                msg = { "msg_type": "ELECTION",
                        ...
                        "args": self.number_of_connections - self.network_id
                       }
    ...
    #                 if self.network_id == self.number_of_connections:
    #                     get_line_info()
